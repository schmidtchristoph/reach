...
#' this, use the function \code{runMatlabFct()}. Discerns the OS X, Linux and MS
#' Windows Matlab app shell command. Automatically changes to the current R
#' working directory in Matlab so that .mat files with Matlab results would be
#' saved there instead of the default Matlab working directory.
#'
